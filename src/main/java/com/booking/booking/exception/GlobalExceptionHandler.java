...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<?> handleInvalidUserIdsException(InvalidUserIdsException ex) {
  ...
  public ResponseEntity<?> handleInvalidBookingIdsException(InvalidBookingIdsException ex) {
    Map<String, Object> body = new HashMap<>();
    body.put("status", HttpStatus.NOT_FOUND.value());
    body.put("message", ex.getMessage());
    body.put("invalidIds", ex.getInvalidIds());
  ...
  public ResponseEntity<?> handleInvalidHotelIdsException(InvalidHotelIdsException ex) {
    Map<String, Object> body = new HashMap<>();
    body.put("status", HttpStatus.NOT_FOUND.value());
    body.put("message", ex.getMessage());
    body.put("invalidIds", ex.getInvalidIds());
  ...
  public ResponseEntity<?> handleInvalidRoomIdsException(InvalidRoomIdsException ex) {
    Map<String, Object> body = new HashMap<>();
    body.put("status", HttpStatus.NOT_FOUND.value());
    body.put("message", ex.getMessage());
    body.put("invalidIds", ex.getInvalidIds());
